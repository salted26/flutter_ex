...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _selectedIndex == 0 ? tabContainer(context, Colors.indigo, "Friends Tab")
        : _selectedIndex == 1
          ? tabContainer(context, Colors.orangeAccent, "Chats Tab")
          : tabContainer(context, Colors.lightBlue, "Settings Tab"),
      bottomNavigationBar: SizedBox(
        ...
        child: TabBar(
          ...
          tabs: [
            ...
            Tab(
              icon: Icon(
                  _selectedIndex == 2 ? Icons.settings : Icons.settings_accessibility_outlined),
              text: "Settings",
            ),
          ],
        ),
